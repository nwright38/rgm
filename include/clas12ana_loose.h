 ...
 class clas12ana : public clas12reader
 {
  ...
  private:
   ...
   double pcal_energy_cut      = 0.05;     //(GeV) minimum energy cut
   double ecal_edge_cut        = 9.8;       //cm
   ...
   std::vector<double> dc_edge_cut_el  = {3.15,2.45,5.25}; //units cm; {region1, region2, region3} cuts for electrons INBENDING
