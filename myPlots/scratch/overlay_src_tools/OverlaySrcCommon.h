...
inline std::vector<PlotVar> defaultVariables() {
  return {
      ...
      {"E1miss", "E1miss", "E_{1,miss} [GeV]", 50, -.3, .55},
      {"E2miss", "E2miss", "E_{2,miss} [GeV]", 50, -0.5, 0.5},
      {"EStar", "EStar", "E^{*} [GeV]", 50, -1.0, 0.5},
    ...
    //    2.4},
      ...
      {"pCMphi", "TMath::ATan2(pCMy, pCMx) * TMath::RadToDeg()", "#phi_{CM} [deg]", 30, -190.0, 190.0},
      ...
      {"alpha_1", "alpha_1", "#alpha_{miss}", 40, 1.0, 1.8},
      {"alpha_2", "alpha_2", "#alpha_{rec}", 40, 0.2, 1.5},
      {"alpha_CM", "alpha_CM", "#alpha_{CM}", 40, 1.5, 3.},
      {"alpha_rel", "alpha_rel", "#alpha_{rel}", 40, 0.4, 1.5},
      {"alpha_q", "alpha_q", "#alpha_{q}", 40, -1.5, -.50},
      {"alpha_pLead", "alpha_pLead", "#alpha_{p_{lead}}", 40, 0., 1.0},
      {"p1_plus", "p1_plus", "p_{miss}^{+} [GeV]", 40, -0.5, 2.5},
      {"p2_plus", "p2_plus", "p_{rec}^{+} [GeV]", 40, -0.5, 2.5},
      {"p1_lc_z", "(p1_plus - alpha_1*m_bar)/2.", "p_{miss,z}^{LC} [GeV/c]", 40,
       -1.2, 1.2},
      {"p2_lc_z", "(p2_plus - alpha_2*m_bar)/2.", "p_{rec,z}^{LC} [GeV/c]", 40,
       -1.2, 1.2},
      {"pCM_lc_z", "((p1_plus+p2_plus) - alpha_CM*m_bar)/2.",
       "p_{CM,z}^{LC} [GeV/c]", 40, -1.2, 1.2},
      {"p1_perp_x", "p1_perp_x", "p_{miss,T,x} [GeV/c]", 40, -0.8, 0.8},
      {"p1_perp_y", "p1_perp_y", "p_{miss,T,y} [GeV/c]", 40, -0.8, 0.8},
      {"p1_perp_mag", "p1_perp_mag", "|p_{miss,T}| [GeV/c]", 40, 0.0, 1.2},
      {"p2_perp_x", "p2_perp_x", "p_{rec,T,x} [GeV/c]", 40, -0.8, 0.8},
      {"p2_perp_y", "p2_perp_y", "p_{rec,T,y} [GeV/c]", 40, -0.8, 0.8},
      {"p2_perp_mag", "p2_perp_mag", "|p_{rec,T}| [GeV/c]", 40, 0.0, 1.2},
    ...
    //    "#theta_{p_{CM}}^{lab} [deg]", 36, 0.0, 180.0},
      {"theta_PCMlabPrel",
       ...
       "pcmz_lab*pcmz_lab)))))) : -999.",
       "Cos(#theta_{p_{CM}^{lab},p_{rel}})", 36, -1., 1.},
