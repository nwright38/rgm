...
NEVENTS_BKG=$(( NEVENTS / 10 )) #10% of events generally make it through to the bg merging stage, targeting approx 1:1 sig:bg; each bg file has max 10000 events available
