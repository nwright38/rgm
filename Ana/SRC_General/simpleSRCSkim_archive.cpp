...
int main(int argc, char **argv)
{
  ...
  clasAna.q2_cut         = {0., 99.};
  clasAna.xb_cut         = {0., 99.};
  clasAna.pmiss_cut      = {0., 99.};
  clasAna.recoil_mom_cut = {.3, 99.};
  clasAna.mmiss_cut      = {0., 99.};
  clasAna.pq_cut         = {0., 99.};
  clasAna.theta_pq_cut   = {0., 180.};
  clasAna.mom_lead_cut   = {0., 99.};
  ...
  meta << "git_hash=" << getCommandOutput("git rev-parse HEAD") << "\n"
       ...
       << "clasAna_config=SRC finder loosened for flat-tree superset: q2=[0,99],xb=[0,99],pmiss=[0,99],recoil_mom=[0.3,99],mmiss=[0,99],pq=[0,99],theta_pq=[0,180],lead_mom=[0,99]\n"
